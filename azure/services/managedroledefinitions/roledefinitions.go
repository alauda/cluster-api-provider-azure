...
func New(scope RoleDefinitionScope) *Service {
	...
	return &Service{
		Scope: scope,
		Reconciler: async.New[armauthorization.RoleDefinitionsClientCreateOrUpdateResponse,
			armauthorization.RoleDefinitionsClientDeleteResponse](scope, client, client),
	}
}
