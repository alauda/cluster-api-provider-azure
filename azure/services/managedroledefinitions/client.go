...
//
//	(result interface{}, poller *runtime.Poller[armprivatedns.RecordSetsClientCreateOrUpdateResponse], err error)
func (ac *azureClient) CreateOrUpdateAsync(ctx context.Context, spec azure.ResourceSpecGetter, resumeToken string, parameters interface{}) (interface{}, *runtime.Poller[armauthorization.RoleDefinitionsClientCreateOrUpdateResponse], error) {
...
func (ac *azureClient) DeleteAsync(ctx context.Context, spec azure.ResourceSpecGetter, resumeToken string) (*runtime.Poller[armauthorization.RoleDefinitionsClientDeleteResponse], error) {
	return nil, nil
}
